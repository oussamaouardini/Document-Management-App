...
export class UploadService {
 ...
 pushUpload(upload: Upload,array : any[],valustatu:any,desc : any) {
   ...
   this.uploadTask.on(firebase.storage.TaskEvent.STATE_CHANGED,
      ...
      //  this.openfileordown(this.fiiilnam);
        this.saveFileData(upload,array,valustatu,desc);
      }
    );
  }
...
makeref(uid,array:any[],valustatu:any,des:any){
...
private saveFileData(upload: Upload,array:any[],valustatu:any,desc:any) {
    this.db.list(`${this.basePath}/`).push(upload);
    this.makeref(55,array,valustatu,desc);
}
